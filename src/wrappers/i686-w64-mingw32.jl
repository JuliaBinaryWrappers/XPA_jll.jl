# Autogenerated wrapper script for XPA_jll for i686-w64-mingw32
...
const libxpa_splitpath = ["bin", "libxpa.dll"]
...
const libxpa = "libxpa.dll"


# Relative path to `xpaaccess`
const xpaaccess_splitpath = ["bin", "xpaaccess.exe"]
...
const xpaget_splitpath = ["bin", "xpaget.exe"]
...
const xpainfo_splitpath = ["bin", "xpainfo.exe"]
...
const xpamb_splitpath = ["bin", "xpamb.exe"]
...
const xpans_splitpath = ["bin", "xpans.exe"]
...
const xpaset_splitpath = ["bin", "xpaset.exe"]
